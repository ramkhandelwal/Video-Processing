...
parser.add_argument('--EncoderModel', type=str, dest="loadmodel", default='./model/L512.pb')
parser.add_argument('--input_frame', type=str, dest="input_path", default='./image/im003.png')
parser.add_argument('--refer_frame', type=str, dest="refer_path", default='./image/im001.png')
parser.add_argument('--outputpath', type=str, dest="outputfolder", default='./testpkl/')
